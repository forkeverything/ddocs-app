...
<head>
    ...
    <title>Project Invitation</title></head>
                                            ...
                                            <tr style="padding:0;text-align:left;vertical-align:top">
                                                <th style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                    <h4 class="main-subject text-green"
                                                        ...
                                                        Invite from {{ $admin->name }} to work on {{ $project->name }}</h4><br>
                                                    <p style="Margin:0;Margin-bottom:10px;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left">
                                                        {{ $admin->name }} ({{ $admin->email }}) has created a 'Project' with us at
                                                        ddocs. A Project is a place for your team to upload relevant
                                                        files and it's how we envisioned a team documents manager should
                                                        be. Concise, accountable and flexible.</p><br>
                                                    <table class="button join radius"
                                                                ...
                                                                <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                    <tr style="padding:0;text-align:left;vertical-align:top">
                                                                        <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;background:#2199e8;border:none;border-collapse:collapse!important;border-radius:3px;color:#fefefe;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;hyphens:auto;line-height:1.3;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                            <a href="{{ env('APP_URL') }}/projects/{{ $project->id }}/join"
                                                                               style="Margin:0;border:0 solid #2199e8;border-radius:3px;color:#fefefe;display:inline-block;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:700;line-height:1.3;margin:0;padding:8px 16px 8px 16px;text-align:left;text-decoration:none">Accept
                                                                                Invitation</a></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <br>
                                                    <p style="Margin:0;Margin-bottom:10px;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left">
                                                        Joining a Project requires you to create an account. Don't
                                                        worry, like other best things in life - it's free!</p></th>
                                                <th class="expander"
