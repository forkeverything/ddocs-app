...
<head>
    ...
    <title>Files Overdue</title></head>
                                ...
                                <tr style="padding:0;text-align:left;vertical-align:top">
                                    <th class="small-12 large-12 columns first last"
                                        ...
                                        <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                            <tr style="padding:0;text-align:left;vertical-align:top">
                                                <th style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                    <h6 class="main-subject text-red"
                                                        style="Margin:0;Margin-bottom:10px;color:#C0392B;font-family:Helvetica,Arial,sans-serif;font-size:18px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left;word-wrap:normal">
                                                        Files Overdue</h6>
                                                    ...
                                                    <table class="callout"
                                                        ...
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th class="callout-inner alert"
                                                                style="Margin:0;background:#fce6e2;border:1px solid #b42912;color:#fefefe;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:10px;text-align:left;width:100%">
                                                                <p style="Margin:0;Margin-bottom:10px;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left">
                                                                    Please upload the following files as soon as you
                                                                    can. Alternatively, if you're done with the list,
                                                                    you can turn off notifications on the checklist
                                                                    page.</p></th>
                                                            <th class="expander"
